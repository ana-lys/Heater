# SMD Hotplate Control with ESP32 and Android App
...
1. **HotPlate ESP32 Schematic, PCB, and Code**: Find the schematic, PCB design, and code for the HotPlate in the following link: [Proteus & Arduino code](insert_link_here).
